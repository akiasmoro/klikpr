    ...
    'app' => [
        ...
        'elements' => [
            ...
            [
                ...
                'class' => '', // any class for input
                'value' => '<a href="https://github.com/nasirkhan/laravel-starter/" class="text-muted">Dinas Perumahan dan Pemukiman Kota Bandar Lampung</a>', // default value if you want
            ],
            [
