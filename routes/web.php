...
Route::get('newsdetail', [NewsController::class, 'detail'])->name('newsdetail');
...
Route::group(['namespace' => 'App\Http\Controllers\Frontend', 'as' => 'frontend.'], function () {
    ...
    Route::get('/newsdetail', 'NewsController@detail')->name('newsdetail');
...
Route::group(['namespace' => 'App\Http\Controllers\Backend', 'prefix' => 'admin', 'as' => 'backend.', 'middleware' => ['auth', 'can:view_backend']], function () {
    ...
    */
    $module_name = 'peta';
    $controller_name = 'PetaController';
    Route::get("{$module_name}", ['as' => "{$module_name}.index", 'uses' => "{$controller_name}@index"]);
    ...
    */
    ...
    $controller_name = 'PengaduanController';
    Route::get("{$module_name}", ['as' => "{$module_name}.index", 'uses' => "{$controller_name}@index"]);
    Route::post("{$module_name}", "{$controller_name}@store")->name("{$module_name}.store");
    ...
    * ---------------------------------------------------------------------
    */
    $module_name = 'konsultasi';
    $controller_name = 'KonsultasiController';
    Route::get("{$module_name}", ['as' => "{$module_name}.index", 'uses' => "{$controller_name}@index"]);
    Route::post("konsultasi_user", "{$controller_name}@store")->name("{$module_name}.store");
    Route::post("konsultasi_tanggapan/{id}", "{$controller_name}@update")->name("{$module_name}.update");
