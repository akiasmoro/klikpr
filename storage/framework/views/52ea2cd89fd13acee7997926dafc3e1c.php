                        ...
                        <table class="table-bordered table-hover table" id="datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <?php echo app('translator')->get('category::text.name'); ?>
                                    </th>
                                    <th>
                                        <?php echo app('translator')->get('category::text.updated_at'); ?>
                                    </th>
                                    <th class="text-end">
                                        <?php echo app('translator')->get('category::text.action'); ?>
                                    </th>
                                </tr>
                            </thead>
                        </table>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Y:\Project\2024\klikpr2\ori\laravel-starter-main\Modules/Category/Resources/views/backend/categories/index_datatable.blade.php ENDPATH**/ ?>