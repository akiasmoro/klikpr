                        ...
                        <table class="table-bordered table-hover table" id="datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <?php echo app('translator')->get('tag::text.name'); ?>
                                    </th>
                                    <th>
                                        <?php echo app('translator')->get('tag::text.updated_at'); ?>
                                    </th>
                                    <th class="text-end">
                                        <?php echo app('translator')->get('tag::text.action'); ?>
                                    </th>
                                </tr>
                            </thead>
                        </table>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Y:\Project\2024\klikpr2\ori\laravel-starter-main\Modules/Tag/Resources/views/backend/tags/index_datatable.blade.php ENDPATH**/ ?>