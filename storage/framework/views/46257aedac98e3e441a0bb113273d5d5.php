    ...
    <div class="container mx-auto flex w-full flex-col items-center justify-center">
        <div class="mb-2 w-full rounded-md border bg-white px-4 py-5 shadow dark:bg-gray-600 dark:text-gray-300 sm:px-6">
            <h3 class="text-lg font-medium leading-6 text-gray-800 dark:text-gray-200">
                <?php echo app('translator')->get('Recent Posts'); ?>
            </h3>
        ...
        <ul class="flex w-full flex-col">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    ...
                    <div
                        ...
                        <div class="flex">
                            <div class="mr-4 flex h-10 flex-col items-center justify-center">
                                <a class="relative block" href="<?php echo e($details_url); ?>">
                                    <img class="mx-auto h-10 rounded object-cover" src="<?php echo e($row->image); ?>"
                            ...
                            <div class="pl-1">
                                ...
                                <div class="text-sm text-gray-600 dark:text-gray-200">
                                    <?php echo e(isset($row->created_by_alias) ? $row->created_by_alias : $row->created_by_name); ?>
...
<?php /**PATH Y:\Project\2024\klikpr2\ori\laravel-starter-main\resources\views/livewire/recent-posts.blade.php ENDPATH**/ ?>