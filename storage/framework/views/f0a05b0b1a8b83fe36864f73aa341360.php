        ...
        <div class="grid grid-cols-1">
            ...
            <p>
                Nasir Khan Saikat and <a href="https://github.com/nasirkhan/laravel-starter/graphs/contributors"
                    target="_blank">contributors</a> built the <?php echo e(config('app.name')); ?> as
            ...
            <p>
                ...
                Website, located at <a href="<?php echo e(config('app.url')); ?>"><?php echo e(config('app.url')); ?></a>.
            </p>
            <p>
            ...
            <p>
                ...
                this from <?php echo e(app_name()); ?> for your own personal use subjected to restrictions set in these terms
                and
                conditions.
            </p>
            <h3 class="mb-2 mt-4 text-2xl">
...
<?php /**PATH Y:\Project\2024\klikpr2\ori\laravel-starter-main\resources\views/livewire/terms.blade.php ENDPATH**/ ?>