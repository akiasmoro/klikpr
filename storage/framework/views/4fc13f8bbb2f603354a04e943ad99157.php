...
<?php endif; ?>
        ...
        <div class="row mt-4">
            <div class="col">
                <form method="post" action="<?php echo e(route('backend.settings.store')); ?>" class="form-horizontal" role="form">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    ...
                                    <?php if ($__env->exists('backend.settings.fields.' . $field['type'] )) echo $__env->make('backend.settings.fields.' . $field['type'] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Y:\Project\2024\klikpr2\ori\laravel-starter-main\resources\views/backend/settings/index.blade.php ENDPATH**/ ?>