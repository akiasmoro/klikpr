...
<?php $__env->startSection('content'); ?>
    ...
    <section class="bg-white dark:bg-gray-800">
        <div class="mx-auto max-w-screen-xl px-4 py-24 text-center sm:px-12">
            <div class="m-6 flex justify-center">
                <img class="h-24 rounded" src="<?php echo e(asset('img/logo-square.png')); ?>" alt="<?php echo e(app_name()); ?>">
            </div>
            ...
            <p class="mb-10 text-lg font-normal text-gray-500 dark:text-gray-400 sm:px-16 sm:text-2xl xl:px-48">
                Selamat Datang di 
                <br/><?php echo setting('app_description'); ?>
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      <div class="col-10 col-sm-8 col-lg-6">
        <img src="<?php echo e(asset('img/tentang-1.jpg')); ?>" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="520" loading="lazy">
      </div>
      <div class="col-lg-6">
        ...
        <div class="container py-5">
            <!-- <div class="w-full text-center lg:w-2/3"> -->
                <!-- <h1 class="mb-4 text-3xl font-medium text-gray-800 dark:text-gray-200 sm:text-4xl">
                    <?php echo e(__('Screenshots of the project')); ?>
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-24 text-center sm:px-12">
            ...
            <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-x-4 sm:space-y-0 ">
                <a class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-5 py-3 text-center text-base font-medium text-gray-900 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:border-gray-700 dark:text-gray-700 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-800"
                    href="#" target="_blank">
                    <img class="h-24 rounded" src="<?php echo e(asset('img/lampung.png')); ?>" alt="<?php echo e(app_name()); ?>">
                </a>
                <a class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-5 py-3 text-center text-base font-medium text-gray-900 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:border-gray-700 dark:text-gray-700 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-800"
                href="#" target="_blank">
                    <img class="h-24 rounded" src="<?php echo e(asset('img/big.png')); ?>" alt="<?php echo e(app_name()); ?>">
                </a>
                <a class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-5 py-3 text-center text-base font-medium text-gray-900 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:border-gray-700 dark:text-gray-700 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-800"
                    href="href="#"" target="_blank">
                    <img class="h-24 rounded" src="<?php echo e(asset('img/brin.png')); ?>" alt="<?php echo e(app_name()); ?>">
                </a>
            </div>
    </div>
    </section>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Y:\Project\2024\klikpr2\ori\laravel-starter-main\resources\views/frontend/index.blade.php ENDPATH**/ ?>