...
<button onclick="window.history.back();" class="btn btn-warning m-1 <?php echo e(($small=='true')? 'btn-sm' : ''); ?>" data-toggle="tooltip" title="<?php echo e(__('Return Back')); ?>"><i class="fas fa-reply fa-fw"></i>&nbsp;<?php echo ($slot != "") ? '&nbsp;' . $slot : ''; ?></button><?php /**PATH Y:\Project\2024\klikpr2\ori\laravel-starter-main\resources\views/components/backend/buttons/return-back.blade.php ENDPATH**/ ?>