...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <i class="<?php echo e($module_icon); ?>"></i> <?php echo e($$module_name_singular->name); ?> <small class="text-muted"><?php echo e(__($module_title)); ?>
...
<?php endif; ?>
                <a class="btn btn-primary btn-sm m-1" data-toggle="tooltip" href="<?php echo e(route('backend.users.index')); ?>"
            ...
            <div class="col">
                <div class="table-responsive">
                    <table class="table-bordered table-hover table">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-outline-primary btn-sm"
                                    href="<?php echo e(route('backend.users.changePassword', $user->id)); ?>">Change password</a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($user->created_at); ?> by
                                User:<?php echo e($user->created_by); ?><br><small>(<?php echo e($user->created_at->diffForHumans()); ?>)</small>
                            </td>
                        </tr>

                        <tr>
                            <th><?php echo e(__('labels.backend.users.fields.updated_at')); ?></th>
                            <td><?php echo e($user->updated_at); ?> by
                                User:<?php echo e($user->updated_by); ?><br /><small>(<?php echo e($user->updated_at->diffForHumans()); ?>)</small>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($user->deleted_at != null): ?>
                                    <?php echo e($user->deleted_at); ?> by
                                    User:<?php echo e($user->deleted_by); ?><br /><small>(<?php echo e($user->deleted_at->diffForHumans()); ?>)</small>
                                <?php endif; ?>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="py-4 text-end">
                    <?php if($user->status != 2): ?>
                        <a class="btn btn-danger mt-1" data-method="PATCH" data-token="<?php echo e(csrf_token()); ?>"
                            data-toggle="tooltip" data-confirm="Are you sure?"
                            href="<?php echo e(route('backend.users.block', $user)); ?>" title="<?php echo e(__('labels.backend.block')); ?>"><i
                                class="fas fa-ban"></i> <?php echo app('translator')->get('Block'); ?></a>
                    <?php endif; ?>
                    <?php if($user->status == 2): ?>
                        <a class="btn btn-info mt-1" data-method="PATCH" data-token="<?php echo e(csrf_token()); ?>"
                            data-toggle="tooltip" data-confirm="Are you sure?"
                            href="<?php echo e(route('backend.users.unblock', $user)); ?>"
                            title="<?php echo e(__('labels.backend.unblock')); ?>"><i class="fas fa-check"></i> <?php echo app('translator')->get('Unblock'); ?></a>
                    <?php endif; ?>
                    <a class="btn btn-danger mt-1" data-method="DELETE" data-token="<?php echo e(csrf_token()); ?>"
                        data-toggle="tooltip" data-confirm="Are you sure?"
                        href="<?php echo e(route('backend.users.destroy', $user)); ?>" title="<?php echo e(__('labels.backend.delete')); ?>"><i
                            class="fas fa-trash-alt"></i> <?php echo app('translator')->get('Delete'); ?></a>
                    <?php if($user->email_verified_at == null): ?>
                        <a class="btn btn-primary mt-1" data-toggle="tooltip"
                            href="<?php echo e(route('backend.users.emailConfirmationResend', $user->id)); ?>"
                            title="Send Confirmation Email"><i class="fas fa-envelope"></i> <?php echo app('translator')->get('Email Confirmation'); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Y:\Project\2024\klikpr2\ori\laravel-starter-main\resources\views/backend/users/show.blade.php ENDPATH**/ ?>