...
<?php endif; ?>
    ...
    <section class="mx-auto max-w-screen-xl bg-white p-6 text-gray-600 sm:p-20">
        <div class="grid grid-cols-1">
            <p>
                At <?php echo e(app_name()); ?>, accessible at <a href="<?php echo e(config('app.url')); ?>"><?php echo e(config('app.url')); ?></a>, one of our main priorities is the privacy
                of our visitors. This Privacy Policy document contains types of information that is collected and
                recorded by <?php echo e(app_name()); ?> and how we use it.
            </p>
            <p>
            ...
            <p>
                ...
                ads to our site visitors based upon their visit to <?php echo e(config('app.url')); ?> and other sites on the
            ...
            <p>
                ...
                are used in their respective advertisements and links that appear on <?php echo e(app_name()); ?>, which are
            ...
            <p>
                Note that <?php echo e(app_name()); ?> has no access to or control over these cookies that are used by
            ...
            <p>
                <?php echo e(app_name()); ?> does not knowingly collect any Personal Identifiable Information from children
...
<?php /**PATH Y:\Project\2024\klikpr2\ori\laravel-starter-main\resources\views/livewire/privacy.blade.php ENDPATH**/ ?>