...
<header class="header header-sticky mb-3 p-0">
        ...
        <ul class="header-nav d-none d-lg-flex">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('frontend.index')); ?>" target="_blank">
                    <?php echo e(app_name()); ?>&nbsp;<i class="fa-solid fa-arrow-up-right-from-square"></i>
                </a>
            </li>
        </ul>
                        ...
                        <?php $__currentLoopData = $notifications_latest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center"
                                    ...
                                    <i
                                        class="<?php echo e(isset($notification->data['icon']) ? $notification->data['icon'] : 'fa-solid fa-bullhorn'); ?>"></i>&nbsp;<?php echo e($notification_text); ?>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button"
                    ...
                    <div class="avatar avatar-md">
                        <img class="avatar-img" src="<?php echo e(asset(auth()->user()->avatar)); ?>"
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('backend.users.show', Auth::user()->id)); ?>">
                        <i class="fa-solid fa-at me-2"></i>&nbsp;<?php echo e(Auth::user()->email); ?>

                    </a>
                    <a class="dropdown-item" href="<?php echo e(route('backend.notifications.index', Auth::user()->id)); ?>">
                        <i class="fa-regular fa-bell me-2"></i>&nbsp;<?php echo app('translator')->get('Notifications'); ?>
                        <?php if($notifications_count): ?>
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                        ...
                        <i class="fa-solid fa-right-from-bracket me-2"></i>&nbsp;<?php echo app('translator')->get('Logout'); ?>
                    </a>
    ...
    <div id="headbreadcumb"  class="container-fluid px-4">
...
<?php /**PATH Y:\Project\2024\klikpr2\ori\laravel-starter-main\resources\views/backend/includes/header.blade.php ENDPATH**/ ?>