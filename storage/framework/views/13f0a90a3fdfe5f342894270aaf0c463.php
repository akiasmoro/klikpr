...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($permission)): ?>
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e($url); ?>">
            <i class="nav-icon <?php echo e($icon); ?>"></i>&nbsp;<?php echo e($text); ?>

        </a>
    </li>
<?php endif; ?>
<?php /**PATH Y:\Project\2024\klikpr2\ori\laravel-starter-main\resources\views/components/backend/sidebar-nav-item.blade.php ENDPATH**/ ?>