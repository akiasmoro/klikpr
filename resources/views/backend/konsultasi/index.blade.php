            ...
            <x-slot name="toolbar">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="perihal" type="text" class="form-control" name="perihal" value="{{ old('perihal') }}" placeholder="Ketik Perihal">
                    </div>
                    <div class="mb-3">
                ...
                @foreach ($module_name_super as $super)
                    <form method="POST" action="konsultasi_tanggapan/ {{ $super->id }}">
                @endforeach
                    @csrf
                    <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Beri Tanggapan No. {{ $super->id }}</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body" style="text-align: left;">
                    <div class="mb-3">
                        <label for="tanggapan" :value="__('tanggapan')" class="form-label">Deskripsi Tanggapan</label>
                        <textarea id="tanggapan" class="form-control" name="tanggapan" value="{{ old('tanggapan') }}" rows="3"></textarea>
                    </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary"> <i class="fas fa-check"></i> Submit</button>
                        ...
                        <table class="table-bordered table-hover table-responsive-sm table" id="datatable">
                            ...
                            @foreach ($$module_name as $module_name_singular)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        {{ $module_name_singular->perihal }}
                                        </td>
                                        <td>
                                        {{ $module_name_singular->deskripsi }}
                                        </td>
                                        <td>
                                        {{ $module_name_singular->tanggapan }}
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a class='btn btn-sm btn-warning mt-1' data-bs-toggle="modal" data-bs-target="#tanggapan" id="{{ $super->id }}"
                                                title="Beri Tanggapan {{ ucwords(Str::singular($module_name)) }}"><i
