...
<div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('backend.peta.index') }}">
                <i class="nav-icon fa-solid fa-map"></i>&nbsp;@lang('Peta')
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('backend.konsultasi.index') }}">
                <i class="nav-icon fa-solid fa-book"></i>&nbsp;@lang('Konsultasi')
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('backend.pengaduan.index') }}">
                <i class="nav-icon fa-solid fa-circle-exclamation"></i>&nbsp;@lang('Pengaduan')
            </a>
        </li>
        <li class="nav-item">
